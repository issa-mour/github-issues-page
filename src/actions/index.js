...
export const getIssues = () => dispatch =>{
	...
	const items = [{id: 4366, comments: 0, state: 'open', title: 'parsing doesn\'t work', user:{login: 'essa.mor'}}, 
		{id: 4365, comments: 2, state: 'open', title: 'fetching doesn\'t work', user:{login: 'thomas1'}}
	];
